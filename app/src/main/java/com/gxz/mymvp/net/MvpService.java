...
import com.gxz.mymvp.BuildConfig;
import com.gxz.mymvp.data.model.ZksDevice;
import com.gxz.mymvp.utils.Coder;
...
public interface MvpService {
     ...
     * 192.168.10.105
     */
    final String URLIP = "192.168.0.100";
    final String ENDPOINT = "http://" + URLIP + "/";
    ...
    @GET("api/get_center_list")
    Observable<HttpResult<DatasResult<List<ZksDevice>>>> getDeviceData();
